...
# Generated on: Tue Feb 13 21:59:51 EET 2024 (Tue Feb 13 19:59:51 UTC 2024)
...
set logfile rtl_elab.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information rtl_elabv_db

# Implementation information for elaborated but not mapped netlist.
# LEC version 18.10-d204 or later is required for the information to be considered.
set lec_version_required "18.10204"
if {$lec_version >= $lec_version_required} {
    set_flatten_model -verification_info_strip_cdn_name_extension
}

read_implementation_information fv/picorv32 -revised elabv
...
read_design -verilog95   -revised -lastmod -noelab elab.v
...
#add_name_alias fv/picorv32/elabv.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.picorv32.rtl.elabv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picorv32.rtl.elabv.rpt
}
report_test_vector -noneq > noneq.test_vector.picorv32.rtl.elabv.rpt
