...
# Generated on: Tue Feb 13 22:06:50 EET 2024 (Tue Feb 13 20:06:50 UTC 2024)
...
set logfile rtl_map.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_mapv_db

read_implementation_information fv/picorv32 -golden fv_map -revised mapv
...
set env(CDN_SYNTH_ROOT) "/mnt/apps/prebuilt/EDA/cadence/2022-23/RHELx86/GENUS/tools.lnx86"
set CDN_SYNTH_ROOT      "/mnt/apps/prebuilt/EDA/cadence/2022-23/RHELx86/GENUS/tools.lnx86"
set env(CW_DIR) "/mnt/apps/prebuilt/EDA/cadence/2022-23/RHELx86/GENUS/tools.lnx86/lib/chipware"
set CW_DIR      "/mnt/apps/prebuilt/EDA/cadence/2022-23/RHELx86/GENUS/tools.lnx86/lib/chipware"
...
add_search_path /mnt/apps/prebuilt/eda/designkits/GPDK/gsclib045/lan/flow/t1u1/reference_libs/GPDK045/gsclib045_svt_v4.4/gsclib045/timing -library -both
...
read_design -verilog95   -golden -lastmod -noelab fv/picorv32/fv_map.v.gz
elaborate_design -golden -root {picorv32}

read_design -verilog95   -revised -lastmod -noelab map.v
elaborate_design -revised -root {picorv32}

#add_name_alias fv/picorv32/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/picorv32/mapv.singlebit.original_name.alias.json.gz -revised
add_name_alias fv/picorv32/mapv.multibit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.picorv32.fv_map.mapv.tcl -class noneq -tclmode -replace
...
report_test_vector -noneq > noneq.test_vector.picorv32.fv_map.mapv.rpt
...
read_implementation_information fv/picorv32 -revised fv_map
...
add_search_path Desktop/VLSI/Verilog/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  Desktop/VLSI/Verilog/picorv32.v
elaborate_design -golden -root {picorv32} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/picorv32/fv_map.v.gz
elaborate_design -revised -root {picorv32}
...
#add_name_alias fv/picorv32/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
set_system_mode lec
write_compared_points noneq.compared_points.picorv32.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picorv32.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.picorv32.rtl.fv_map.rpt
