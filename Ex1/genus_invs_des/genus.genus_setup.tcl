...
if {$_slk_ != "29.1"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 29.1,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "31216"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 31216,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "12919"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 12919,  current net area: $_net_area_"
}
unset _net_area_
