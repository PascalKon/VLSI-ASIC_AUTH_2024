...
#check design
check_design -all > Desktop/VLSI/Exercises/Ex1/Step4/v2/Ex1_Step4_v2_Check_Design.txt

#read the sdc file
read_sdc Ex1_Step4_v2.sdc

#check if its ok
check_timing_intent > Desktop/VLSI/Exercises/Ex1/Step4/v2/Ex1_Step4(v2)_Check_Timing_Intent.txt
