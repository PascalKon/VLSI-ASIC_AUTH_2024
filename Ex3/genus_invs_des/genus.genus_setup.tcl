...
if {$_slk_ != "8.3"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 8.3,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "34004"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 34004,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "13922"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 13922,  current net area: $_net_area_"
}
unset _net_area_
