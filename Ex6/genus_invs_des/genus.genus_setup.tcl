...
if {$_slk_ != "2.2"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 2.2,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "27176"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 27176,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "11836"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 11836,  current net area: $_net_area_"
}
unset _net_area_
