...
if {$_slk_ != "8.8"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 8.8,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "34341"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 34341,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "15657"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 15657,  current net area: $_net_area_"
}
unset _net_area_
# scan chain count
if {[llength [::legacy::find design:picorv32 -scan_chain *]] != "1"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden # scan chains: 1  current # scan chains: [llength [::legacy::find design:picorv32 -scan_chain *]]"
}
